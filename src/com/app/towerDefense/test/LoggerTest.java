...
/**
 * This class test each log of items(buy tower, sell tower, upgrade tower, critter hits) 
...
public class LoggerTest {
	...
	public void buyTowerlogTest() 
	{
		...
		String output = new  LogReader(ApplicationStatics.LOG_File_PATH, e_logViewState.TowerLog,  PlayerModel.towerModelArray.get(0)).read();
